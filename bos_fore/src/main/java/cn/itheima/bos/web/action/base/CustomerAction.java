...
import cn.itheima.bos.utils.MailUtils;
...
public class CustomerAction extends BaseAction<Customer>{
	...
	@Action(value="customer_regist",results={
		...
		@Result(name="input",type="redirect",location="sign.html")
	})
	public String regist() {
		...
		MailUtils.sendMail("速运快递账户激活邮件", content, model.getEmail());
